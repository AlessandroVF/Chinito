                        ...
                        <div class="card-body" style="display: block;">
                            <div class="col">
                                <div class="col-md-12">
                                    ...
                                    <form action="../../config/controladores/empleados/registro_empleado.php"  method="post" autocomplete="off">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="apellido" name="apellido" class="form-control" required maxlength="50">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="cargo" name="cargo" class="form-control" required maxlength="50">
                                                        </div>
                                                    </div>
                                                </div>
