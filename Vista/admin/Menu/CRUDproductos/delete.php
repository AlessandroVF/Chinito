                        ...
                        <div class="card-body" style="display: block;">
                            <div class="col">
                                <div class="col-md-12">
                                    ...
                                    <form action="../../config/controladores/productos/elimina_producto.php" enctype="multipart/form-data" method="post" autocomplete="off">
                                    ...
                                    <input type="hidden" name="idProducto" value="<?php echo $producto['idProducto']; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button type="submit"  value="Eliminar Producto" class="btn btn-warning">Eliminar Producto</button>
                                        </div>                                        
                                    </form>
                                </div>
                            </div>
