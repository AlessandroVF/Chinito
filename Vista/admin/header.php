...
<head>
 ...
 <link rel="stylesheet" href="../admin/Menu/menu.css">
 ...
 <nav class="sidebar close">
        ...
        <div class="menu-bar">
          ...
          <img src="../admin/Menu/CantanteVernacular.jpg" alt="profile_picture"> <!-- Corregimos las comillas y agregamos la etiqueta img -->
          ...
          <p>Developer</p>
                ...
                <ul class="menu-links">
                    ...
                    <!-- LINK 2 -->
                    <li class="nav-link">
                        <a href="/Menu/CRUDEmpleados/Empleados.php">
