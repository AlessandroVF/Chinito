                        ...
                        <div class="card-body" style="display: block;">
                            <div class="col">
                                <div class="col-md-12">
                                    ...
                                    <form action="../../config/controladores/proveedores/registro_proveedor.php"  method="post" autocomplete="off">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" id="ruc" name="ruc" class="form-control" required >
                                                        </div>
                                                    </div>
                                                </div>  
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button type="submit"  value="Guardar Proveedor" class="btn btn-primary">Guardar Proveedor</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
