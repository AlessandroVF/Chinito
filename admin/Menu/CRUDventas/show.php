...
$id = $_GET['id'];
//
$sql = $con ->prepare("SELECT id_producto, nombre,precio,cantidad FROM detalleventa WHERE id_venta=?");
$sql -> execute([$id]);
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name=" "value="<?php echo $datos_cliente['direccion'];?>" id="direccion" cols="30" rows="3" class="form-control" disabled>  </textarea>
                                                </div>
                                            </div>
                                        </div>
